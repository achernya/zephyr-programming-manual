...
%	$Author: jtkohl $
%	$Header: /tmp/git-rcsimport-Ge1GfW1M7y/rcs/zephyr.tex,v 2.0 1989/04/05 15:58:55 jtkohl Exp $
%
\iffalse		 % true for 21.780 style, false for real

\documentstyle[zephyrdoc,doublespace,timrom,12pt]{article}
\setstretch{1.7}
...
\documentstyle[zephyrdoc,timrom,twoside]{article}
